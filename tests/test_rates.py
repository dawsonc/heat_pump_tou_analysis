...
class TestPresetIntegrity:
    def test_rate_presets_dict_contains_both(self) -> None:
        """RATE_PRESETS has both Flat Rate and Eversource R-1HP."""
    ...
    def test_customer_charges_non_negative(self) -> None:
        ...
        for schedule in [FLAT_RATE, EVERSOURCE_R1HP, CUSTOM_TOU_TEMPLATE]:
